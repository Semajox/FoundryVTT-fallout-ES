...
Hooks.once('ready', () => {
    if(typeof libWrapper !== 'undefined') {
        libWrapper.register('fallout-es', 'ui.notifications.notify', localizeUiNotification)
        libWrapper.register('fallout-es', 'ui.notifications.warn', localizeUiNotification)
    }
});